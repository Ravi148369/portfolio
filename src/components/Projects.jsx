...
const Projects = () => {
  return (
    <MotionFadeDiv>
      <section className='lg:w-10/12 h-min-screen pb-8 ml-auto lg:mr-8' id='projects'>
        <div className='pt-6'>
          <h2 className='text-center lg:text-5xl text-3xl font-bold tracking-wider'>MY RECENT WORK</h2>
          <p className='text-center lg:text-lg mt-4'>Here are a few past projects I've worked on. Want to see more? <a href="#contact" className='text-blue-500'>Email me</a>.</p>
        </div>
                ...
                <div className='lg:w-3/12 w-96 m-4'>
                  <MotionScaleDiv>
                    <div className='shadow-lg bg-white rounded-lg overflow-hidden'>
                        <div className='lg:w-62 lg:h-44 h-52 rounded-lg overflow-hidden'>
